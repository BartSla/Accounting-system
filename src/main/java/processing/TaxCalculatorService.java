...
public class TaxCalculatorService implements Visitor {
    ...
    Buyer myCompanyB = new Buyer("ABC", "8909870908", "Nowa15", "Wroclaw", "54-317");
    Seller myCompanyS = new Seller("ABC", "8909870908", "Nowa15", "Wroclaw", "54-317");
