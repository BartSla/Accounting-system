...
public class InvoiceProvider {
    ...
    Invoice invoice1 = new Invoice(buyer1, seller1, 1, LocalDate.now());
    Invoice invoice2 = new Invoice(buyer2, seller2, 1, LocalDate.now());
    Invoice invoice3 = new Invoice(buyer3, seller3, 1, LocalDate.now());
    Invoice invoice4 = new Invoice(buyer4, seller4, 1, LocalDate.now());
